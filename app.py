...
def predict_overall_sales(periods, output_choice):
    ...
    output_df.rename(columns={
        'ds': 'Date', # Renamed in table, but not in plot axes automatically by Prophet
    ...
    plt.xlabel('Datestamp') # Changed here for the main forecast plot
    ...
    # Iterate through subplots to change x-axis label from 'ds' to 'Datestamp'
    for ax in fig2.axes:
        ax.set_xlabel('Datestamp') # Changed here for component plots
